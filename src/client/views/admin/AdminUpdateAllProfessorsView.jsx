...
function AdminUpdateAllProfessorsView(ComponentClass) {
	return props => <ComponentClass {...props} params={useParams()} />;
}

class AdminUpdateAllProfessorsViewClass extends Component {
	constructor(props) {
		super(props);
...
export default AdminUpdateAllProfessorsView(AdminUpdateAllProfessorsViewClass);
